...
| 8.1.2   |                         |                                                             | 사용자가 'Good First Issue 보기' 버튼 클릭 또는 필터 옵션 선택                      |     |      |
...
| 9.6.1   |                         |                                                             | 사용자가 '기여도 랭킹 확인' 메뉴 선택                                            |     |      |
| 9.6.2   |                         |                                                             | 시스템은 전체 사용자 또는 팀원의 기여 데이터 수집                                      |     |      |
| 9.6.3   |                         |                                                             | 활동 지수를 기반으로 점수 계산                                                 |     |      |
| 9.6.4   |                         |                                                             | 점수 순으로 정렬하여 순위 리스트 출력                                             |     |      |
| 9.6.5   |                         |                                                             | 사용자별 기여도 점수 및 순위 목록(상위 10명 표시, 나의 순위 강조)                          |     |      |
...
| 9.7.5   |                         |                                                             | 획득한 뱃지 리스트와 알림 메시지를 출력한다.                                         |     |      |
| 10      | 일반 커뮤니케이션               |                                                             |                                                                   |     |      |
...
| 10.7.1  |                         |                                                             | 사용자는 자신이 작성한 댓글 옆의 ‘수정’ 버튼을 클릭하여 수정 모드로 진입한다.                     |     |      |
| 10.7.2  |                         |                                                             | 수정 모드에서는 기존 댓글의 내용을 편집할 수 있다.                                     |     |      |
| 10.7.3  |                         |                                                             | 사용자가 수정 완료 후 저장 버튼을 누르면 DB의 댓글 데이터가 갱신된다.                         |     |      |
| 10.7.4  |                         |                                                             | 다른 사용자가 작성한 댓글은 수정할 수 없으며, 관리자 계정은 예외적으로 수정 권한을 가질 수 있다           |     |      |
| 10.8    | 댓글 삭제                   | 작성한 댓글을 삭제할 수 있다.                                           |                                                                   |     |      |
| 10.8.1  |                         |                                                             | 사용자는 자신이 작성한 댓글 옆의 ‘삭제’ 버튼을 클릭하여 삭제를 요청한다.                        |     |      |
| 10.8.2  |                         |                                                             | 삭제 시, 시스템은 삭제 확인 팝업을 제공한다.                                        |     |      |
| 10.8.3  |                         |                                                             | 사용자가 확인을 선택하면 해당 댓글이 DB에서 삭제 처리된다.                                |     |      |
| 10.8.4  |                         |                                                             | 삭제된 댓글은 상세 화면에서 표시되지 않는다.                                         |     |      |
| 10.8.5  |                         |                                                             | 다른 사용자가 작성한 댓글은 삭제할 수 없으며, 관리자 계정은 예외적으로 삭제 권한을 가질 수 있다.          |     |      |
| 10.9    | 커뮤니티 알림 확인              | 댓글, 대댓글의 알림을 확인할 수 있다.                                      |                                                                   |     |      |
| 10.9.1  |                         |                                                             | 사용자는 메인 페이지 상단의 ‘알림 버튼’을 클릭하여 알림 목록을 확인할 수 있다                     |     |      |
| 10.9.2  |                         |                                                             | 알림 목록에는 미확인 알림이 우선 표시되며, 각각의 알림에는 알림 제목과 내용, 알림 시각이 표시된다.         |     |      |
| 10.9.3  |                         |                                                             | 사용자가 알림 항목을 클릭하면 해당 이벤트가 발생한 게시글 상세 화면 또는 스터디 화면으로 이동한다.          |     |      |
| 10.9.4  |                         |                                                             | 알림을 열람하면 해당 알림은 자동으로 '읽음' 상태로 변경된다.                               |     |      |
| 10.10   | 관리자 게시글 관리              | 커뮤니티 관리자는 모든 게시물을 삭제할 수 있다.                                 |                                                                   |     |      |
| 10.10.1 |                         |                                                             | 게시판 관리자는 게시글 상세 화면에서 모든 사용자의 게시글을 관리할 수 있다.                       |     |      |
| 10.10.2 |                         |                                                             | 관리자는 일반 사용자가 작성한 게시글에 대해 조회, 수정, 삭제 권한을 가진다.                      |     |      |
| 11      | OSS 뉴스                  |                                                             |                                                                   |     |      |
