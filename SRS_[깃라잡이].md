...
| 3.5 | 게시글 상세 조회 | 게시글의 세부 내용을 확인한다. | 특정 게시글의 내용을 조회하고 관련 댓글 및 메타 정보를 표시한다. | | | | UC 3.5 | H | |
...
| 3.8.2 | | | 다른 사용자가 작성한 댓글의 '삭제' 버튼은 보이지 않는다. | commentId, githubId | githubId (댓글 작성자와 불일치) | | UC 3.8.2 | H | |
